...
class AzureProvider(ProviderBase):
    ...
    def get_node(self, node_id, api_version="2020-12-01"):
        ...
        action = ("subscriptions/{}/providers/Microsoft.Compute/"
    ...
    def _parse_image(self, name, size, gallery="myGallery", image="mssql_2019_0_0", version="1.0.0"):
        ...
        image_id = ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Compute/"
                    "galleries/{}/images/{}/versions/{}".format(self.credential.subscription_id,
                                                                self.credential.resource_group,
                                                                gallery, image, version))

        network_id = ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Network/"
                      "networkInterfaces/{}".format(self.credential.subscription_id,
    ...
    def offering_to(self, cpu, memory, api_version="2020-12-01"):
        ...
        base_url = self.azClient.endpoint
        action = ("subscriptions/{}/providers/Microsoft.Compute/"
                  "locations/{}/vmSizes?api-version={}".format(self.credential.subscription_id,
    ...
    def _parse_nic(self, name, vnet, subnet, version="1.0.0"):
        ...
        id = ("/subscriptions/{}/resourceGroups/{}/providers/Microsoft.Network"
              "/virtualNetworks/{}/subnets/{}".format(self.credential.subscription_id,
    ...
    def create_nic(self, name, api_version="2020-07-01"):
        ...
        action = ("subscriptions/{}/resourceGroups/{}/providers/Microsoft.Network/"
                  "networkInterfaces/{}?api-version={}".format(self.credential.subscription_id,
                                                               self.credential.resource_group,
                                                               name, api_version))
    ...
    def get_network(self, api_version="2020-07-01"):
        ...
        action = ("subscriptions/{}/resourceGroups/{}/providers/Microsoft.Network/"
                  "virtualNetworks/{}?api-version={}".format(self.credential.subscription_id,
                                                             self.credential.resource_group,
                                                             vnet, api_version))
    ...
    def _list_vm(self, name, only_status=True, api_version="2020-12-01"):
        ...
        action = ("subscriptions/{}/providers/Microsoft.Compute/"
                  "virtualMachines/?api-version={}&statusOnly={}".format(self.credential.subscription_id,
    ...
    def deploy_vm(self, name, size, api_version="2020-12-01"):
        ...
        if nic_metadata.status_code in [response_created.CREATED]:
            ...
            self.get_azure_connection()
            base_url = self.azClient.endpoint
            action = ("subscriptions/{}/resourceGroups/{}/providers/Microsoft.Compute/"
                      "virtualMachines/{}?api-version={}".format(self.credential.subscription_id,
                                                                 self.credential.resource_group,
                                                                 name, api_version))
